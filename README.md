...
#For detials of the "forceLPS" parameter, please see the example of read.markups.fcsv() below and its associated help file.
Warning message:
In readLines(file) :
...
#An example of the updated read.markups.fcsv() with the "forceLPS" parameeter
#forceLPS = FALSE
